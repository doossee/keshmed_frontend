...
useSeoMeta({
    keywords: `${product.value?.title_en}, ${product.value?.title_ru}, ${product.value?.title_uz}`,
...
useHead({
    meta: [
        { id: 'og:price:amount', property: 'og:price:amount', content: `${product.value?.price} USD` },
        { id: 'og:price:currency', property: 'og:price:currency', content: 'USD' },
        { id: 'product:price:amount', property: 'product:price:amount', content: `${product.value?.price} USD` },
