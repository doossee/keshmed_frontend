...
import { u as useI18n, V as VContainer, a as VRow, b as VCol, c as VTextField, f as VCard, g as VCardTitle, h as VCardText, t as VDataTableServer, v as VChip, e as VIcon, n as VSelect, o as VPagination } from './server.mjs';
                                  ...
                                  if (_push6) {
                                    ...
                                    _push6(ssrRenderComponent(VDataTableServer, {
                                      ...
                                      "item.status": withCtx(({ item, column, index }, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<td${ssrRenderAttr("data-label", column.title)}${_scopeId6}><div class="d-flex ga-1"${_scopeId6}>`);
                                          ...
                                          _push7(ssrRenderComponent(VChip, {
                                            variant: "flat",
                                            color: "red",
                                            onClick: ($event) => handleDelete(item.id, index)
                                          }, {
                                            default: withCtx((_6, _push8, _parent8, _scopeId7) => {
                                              if (_push8) {
                                                _push8(ssrRenderComponent(VIcon, null, {
