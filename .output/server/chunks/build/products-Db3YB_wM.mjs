import { useSSRContext, defineComponent, ref, reactive, withCtx, createVNode, toDisplayString, unref, withModifiers, createTextVNode, openBlock, createBlock, createCommentVNode, Fragment, renderList, mergeProps } from 'vue';
import { ssrRenderComponent, ssrInterpolate, ssrRenderClass, ssrRenderList } from 'vue/server-renderer';
import { a3 as useRoute$1, P as useRouter$1, V as VContainer, a as VRow, b as VCol, f as VCard, h as VCardText, c as VTextField, D as VList, e as VIcon, l as VListItem, o as VPagination, j as VAvatar, k as VImg, m as VListItemTitle, H as VListItemSubtitle } from './server.mjs';
