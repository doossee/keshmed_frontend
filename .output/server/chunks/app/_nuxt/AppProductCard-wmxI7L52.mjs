import { defineComponent, resolveComponent, mergeProps, withCtx, createTextVNode, toDisplayString, createVNode, unref, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrInterpolate } from 'vue/server-renderer';
import { c as countries } from './index-ppswWwq3.mjs';
import { g as VCard, l as VImg, N as VDivider, i as VCardText } from '../server.mjs';
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_router_link, {
              ...
              class: "px-3 text-decoration-none font-weight-medium text-subtitle-1 py-1 text-primary"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                var _a2, _b2;
                if (_push3) {
                  _push3(`${ssrInterpolate((_a2 = _ctx.item) == null ? void 0 : _a2[`title_${_ctx.$i18n.locale}`])}`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(VCardText, { class: "py-1 px-3" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                var _a2, _b2;
                if (_push3) {
            ...
            return [
              ...
              createVNode(VCardText, { class: "py-1 px-3" }, {
                default: withCtx(() => {
                  var _a2;
                  return [
                    createVNode("span", { class: "font-weight-medium" }, toDisplayString(_ctx.$t("products.price")) + ":", 1),
