...
import { useSSRContext, defineComponent, computed, mergeProps, withCtx, unref, createTextVNode, toDisplayString, createVNode, withDirectives, vShow, openBlock, createBlock, Fragment, renderList, renderSlot, ref, h, resolveComponent } from 'vue';
import { a5 as _export_sfc, U as useRoute$1, u as useI18n, a1 as useDisplay, a3 as VAppBar, V as VContainer, e as VBtn, G as VMenu, k as VAvatar, l as VImg, H as VList, m as VListItem, n as VListItemTitle, f as VIcon, ae as VFooter, a as VRow, b as VCol, N as VDivider, Y as VApp, Z as VMain, W as useRouter$1, a6 as hasProtocol, a7 as joinURL, a8 as parseURL, a9 as parseQuery$1, aa as nuxtLinkDefaults, ab as useRuntimeConfig, a0 as navigateTo, ac as withTrailingSlash$1, ad as withoutTrailingSlash$1 } from '../server.mjs';
import { ssrRenderComponent, ssrInterpolate, ssrRenderAttr, ssrRenderList, ssrRenderAttrs, ssrRenderSlot } from 'vue/server-renderer';
import { _ as _imports_0$1 } from './keshmed-logo-bly5Azg7.mjs';
import { l as languages, s as social_links, n as navigation_links } from './index-ppswWwq3.mjs';
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(VBtn, {
          ...
          rounded: "circle",
          color: "primary",
          style: { "border": "2px solid #fff", "position": "fixed", "right": "50px", "bottom": "50px", "z-index": "444" }
        }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
...
const indexLayout = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { indexLayout as default };
